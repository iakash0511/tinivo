    ...
    <main className="min-h-screen px-4 py-12">
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10 w-full">
        ...
        <div className="flex flex-col gap-8">
          ...
          <OrderPackingSection
            videoMp4Url={"https://res.cloudinary.com/dltpeh88i/video/upload/v1772742302/default-tinivo-packing-video_ippdzr.mp4"}
            videoWebmUrl={"https://res.cloudinary.com/dltpeh88i/video/upload/v1772742302/default-tinivo-packing-video_ippdzr.webm"}
            posterUrl={"https://res.cloudinary.com/dltpeh88i/video/upload/so_0,f_jpg,q_auto,w_720/tinivo/packing/tinivo-packing-default_oeaiv3.jpg"}
          />
