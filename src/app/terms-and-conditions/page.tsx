...
export const metadata = {
  title: "Terms and condition | Tinivo",
  description: "Terms and condition of Tinivo.",
}
  ...
  return (
   <PageContainer>
        ...
        <p className="text-left text-neutral-600 font-body">
            {`For the purpose of these Terms and Conditions, The term "we", "us", "our" used anywhere on this page shall mean Tinivo, 
            whose registered/operational office is 12a sathanipet 2nd street maduvinkarai guindy Chennai TAMIL NADU 600032 . 
            ...
            Unauthorized use of information provided by us shall give rise to a claim for damages and/or be a criminal offense. From time to time our website may also include links to other websites. 
            These links are provided for your convenience to provide further information. You may not create a link to our website from another website or document without our prior written consent. 
